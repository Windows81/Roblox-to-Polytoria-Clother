...
(magick "$1" -size 1024x1024 xc:none -background none \
  ...
  \( -clone 0 -crop 128x128+231+074 -scale 146x290! -splice 439x103+0+0 +repage `# Torso F` \) \
  \( -clone 0 -crop 064x128+361+074 -scale 088x290! -splice 585x103+0+0 +repage `# Torso L` \) \
  \( -clone 0 -crop 128x064+231+008 -scale 146x096! -splice 439x007+0+0 +repage `# Torso U` \) \
  \( -clone 0 -crop 128x064+231+204 -scale 146x096! -splice 439x393+0+0 +repage `# Torso D` \) \
  \( -clone 0 -crop 128x128+427+074 -scale 146x290! -splice 439x519+0+0 +repage `# Torso B` \) \
  \
